...
**
** Created: Sat Oct 29 09:24:39 2011
...
static const char qt_meta_stringdata_test_qt[] = {
    "test_qt\0"
};

const QMetaObject test_qt::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_test_qt,
      qt_meta_data_test_qt, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &test_qt::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_test_qt))
